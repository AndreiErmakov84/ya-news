...
# from django.utils.unittest import skip  # Для старых версий Django
from unittest import skip  # Для новых версий
...
@skip('Пропуск всех тестов класса')  # Отменяет выполнение обернутых классов
